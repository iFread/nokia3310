...
void set_byte( unsigned char dd,bool b)    // беззнаковый char содержит команду или данные
{
...
void lcd_init()
{  // в течение 30мс после подачи питания должна быть инициализация
 port&=~(1<<res);
 delay_mks();
 port|=(1<<res);
...
set_byte(0b00010011,false); // 0x13 BiasSystem - смещение напряжения
 ...
 set_byte(0b00100000,false); //0x20 functionSet
 set_byte(0b00001100,false);// 0x0C настраиваем отображение
 //установить курсор
